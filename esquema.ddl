CREATE TABLE ALUMNO (DNI VARCHAR(9) NOT NULL, Email_Institucional VARCHAR(100) NOT NULL, Email_Personal VARCHAR(100), Telefono_Movil VARCHAR(20), Nombre_Completo VARCHAR(100) NOT NULL, Telefono_Fijo VARCHAR(20), PRIMARY KEY (DNI))
...
CREATE TABLE EXPEDIENTE (Numero_Expediente INTEGER NOT NULL, Activo BOOLEAN, Nota_Media_Provisional INTEGER, ALUMNO_DNI VARCHAR(9), TITULACION_Codigo_Titulacion INTEGER, PRIMARY KEY (Numero_Expediente))

...
CREATE TABLE ASIGNATURA (Referencia INTEGER NOT NULL, DTYPE VARCHAR(31), Duracion INTEGER, Caracter VARCHAR(20), Codigo_Asignatura INTEGER NOT NULL, Creditos INTEGER NOT NULL, Curso VARCHAR(10), Idiomas_Imparticion VARCHAR(100), Nombre VARCHAR(20) NOT NULL, Ofertada TINYINT(1) default 0 NOT NULL, Unidad_Temporal_Cuatrimestre VARCHAR(20), TITULACION_Codigo_Titulacion INTEGER, Mencion VARCHAR(20), Plazas INTEGER NOT NULL, PRIMARY KEY (Referencia))
CREATE TABLE CENTRO (ID INTEGER NOT NULL, Direccion VARCHAR(200) NOT NULL, Nombre VARCHAR(20) NOT NULL UNIQUE, Telefono_Conserjeria VARCHAR(20), PRIMARY KEY (ID))
...
CREATE TABLE ENCUESTA (Fecha_Envio DATE NOT NULL, EXPEDIENTE_Numero_Expediente INTEGER, PRIMARY KEY (Fecha_Envio))
CREATE TABLE EXPEDIENTE (Numero_Expediente INTEGER NOT NULL, Activo TINYINT(1) default 0, Nota_Media_Provisional INTEGER, ALUMNO_ID INTEGER, TITULACION_Codigo_Titulacion INTEGER, PRIMARY KEY (Numero_Expediente))
CREATE TABLE GRUPO (ID INTEGER NOT NULL, Asignar VARCHAR(20), Curso INTEGER NOT NULL, Ingles TINYINT(1) default 0 NOT NULL, Letra VARCHAR(1) NOT NULL, Plazas INTEGER, Turno_Mañana_Tarde VARCHAR(10) NOT NULL, Visible TINYINT(1) default 0, GRUPO_ID INTEGER, TITULACION_Codigo_Titulacion INTEGER, PRIMARY KEY (ID))
CREATE TABLE GRUPOSPORASIG (Oferta TINYINT(1) default 0, Curso_Academico VARCHAR(10) NOT NULL, ASIGNATURA INTEGER NOT NULL, GRUPO INTEGER NOT NULL, ASIGNATURA_Referencia INTEGER, GRUPO_ID INTEGER, PRIMARY KEY (Curso_Academico, ASIGNATURA, GRUPO))
CREATE TABLE MATRICULA (Curso_Academico VARCHAR(10), Estado VARCHAR(10) NOT NULL, Fecha_Matricula DATETIME NOT NULL, Listado_Asignaturas VARCHAR(500), Nuevo_Ingreso TINYINT(1) default 0, Numero_Archivo INTEGER, Turno_Preferente VARCHAR(10), CURSOACADEMICO VARCHAR(255) NOT NULL, EXPEDIENTE BIGINT NOT NULL, EXPEDIENTE_Numero_Expediente INTEGER, PRIMARY KEY (CURSOACADEMICO, EXPEDIENTE))
CREATE TABLE TITULACION (Codigo_Titulacion INTEGER NOT NULL, Creditos INTEGER NOT NULL, Nombre VARCHAR(20) NOT NULL, PRIMARY KEY (Codigo_Titulacion))
...
CREATE TABLE ENCUESTA_GRUPOSPORASIG (contieneEncuestas_Fecha_Envio DATE NOT NULL, Curso_Academico VARCHAR(10) NOT NULL, ASIGNATURA INTEGER NOT NULL, GRUPO INTEGER NOT NULL, PRIMARY KEY (contieneEncuestas_Fecha_Envio, Curso_Academico, ASIGNATURA, GRUPO))

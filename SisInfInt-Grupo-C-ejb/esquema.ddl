CREATE TABLE ALUMNO (ID INTEGER IDENTITY NOT NULL, DNI VARCHAR(9) NOT NULL UNIQUE, Email_Institucional VARCHAR(100) NOT NULL, Email_Personal VARCHAR(100), Telefono_Movil VARCHAR(20), Nombre_Completo VARCHAR(100) NOT NULL, Telefono_Fijo VARCHAR(20), PRIMARY KEY (ID))
CREATE TABLE ASIGNATURA (Referencia INTEGER NOT NULL, DTYPE VARCHAR(31), Caracter VARCHAR(20), Codigo_Asignatura INTEGER NOT NULL, Creditos INTEGER NOT NULL, Curso VARCHAR(10), Duracion INTEGER, Idiomas_Imparticion VARCHAR(100), Nombre VARCHAR(100) NOT NULL, Ofertada BOOLEAN NOT NULL, Unidad_Temporal_Cuatrimestre VARCHAR(20), TITULACION_Codigo_Titulacion INTEGER, Mencion VARCHAR(20), Plazas INTEGER, PRIMARY KEY (Referencia))
...
CREATE TABLE ENCUESTA (Fecha_Envio TIMESTAMP NOT NULL, MATRICULACIONINGLES VARCHAR, TURNOPREFERENTE VARCHAR, EXPEDIENTE_Numero_Expediente INTEGER, PRIMARY KEY (Fecha_Envio))
CREATE TABLE EXPEDIENTE (Numero_Expediente INTEGER NOT NULL, Activo BOOLEAN, Nota_Media_Provisional DOUBLE, ALUMNO_ID INTEGER, TITULACION_Codigo_Titulacion INTEGER, PRIMARY KEY (Numero_Expediente))
...
CREATE TABLE MATRICULA (Curso_Academico VARCHAR(10), Estado VARCHAR(10) NOT NULL, Fecha_Matricula TIMESTAMP NOT NULL, Listado_Asignaturas VARCHAR(500), Nuevo_Ingreso BOOLEAN, Numero_Archivo INTEGER, Turno_Preferente VARCHAR(10), EXPEDIENTE INTEGER NOT NULL, EXPEDIENTE_Numero_Expediente INTEGER, PRIMARY KEY (EXPEDIENTE))
...
CREATE TABLE ASIGNATURA_MATRICULA (ASIGNATURA_Referencia INTEGER NOT NULL, EXPEDIENTE INTEGER NOT NULL, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (ASIGNATURA_Referencia, EXPEDIENTE))
...
ALTER TABLE ASIGNATURA_MATRICULA ADD CONSTRAINT FK_ASIGNATURA_MATRICULA_EXPEDIENTE FOREIGN KEY (EXPEDIENTE) REFERENCES MATRICULA (EXPEDIENTE)

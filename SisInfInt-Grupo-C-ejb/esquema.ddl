...
CREATE TABLE MATRICULA (Curso_Academico VARCHAR(10), Estado VARCHAR(10) NOT NULL, Fecha_Matricula TIMESTAMP NOT NULL, Listado_Asignaturas VARCHAR(500), Nuevo_Ingreso BOOLEAN, Numero_Archivo INTEGER, Turno_Preferente VARCHAR(10), CURSOACADEMICO VARCHAR NOT NULL, EXPEDIENTE INTEGER NOT NULL, EXPEDIENTE_Numero_Expediente INTEGER, PRIMARY KEY (CURSOACADEMICO, EXPEDIENTE))
...
CREATE TABLE ASIGNATURA_MATRICULA (ASIGNATURA_Referencia INTEGER NOT NULL, EXPEDIENTE INTEGER NOT NULL, CURSOACADEMICO VARCHAR NOT NULL, GRUPO_ID INTEGER NOT NULL, PRIMARY KEY (ASIGNATURA_Referencia, EXPEDIENTE, CURSOACADEMICO))
